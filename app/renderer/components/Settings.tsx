        ...
        >
              ...
              return (
                <Setting key={f.key}>
                  ...
                  <Switch
                    ...
                    checked={
                      data.features.find((df) => df.key == f.key).enabled
                    }
            ...
            <Setting>
              ...
              >
                <Switch
                  ...
                  checked={
                    data.features?.calendarIntegration
                      ? data.features.calendarIntegration
                      : false
                  }
                  onColor={theme.colours.primaryColour}
          ...
          <SettingsCategory>
            ...
            {showColourPicker && (
              <Popover
                top={
                  document.getElementById(colourPickerTriggeredBy).offsetTop +
                  25
                }
                left={
                  document.getElementById(colourPickerTriggeredBy).offsetLeft
                }
              >
                <StyledTwitterPicker
                  key={"tp"}
