...
export const Wrapper = styled.div`
  ...
  .react-datepicker__month-year-read-view--down-arrow::before {
    ...
    border-width: 8px;
    left: -8px;
    border-bottom-color: ${(props) => props.theme.colours.borderColour};
  }
  ...
  .react-datepicker-popper[data-placement^='bottom'] .react-datepicker__triangle::before {
    border-top: none;
    border-bottom-color: ${(props) => props.theme.colours.dialogBackgroundColour};
  }
  ...
  .react-datepicker__navigation--previous {
    left: 10px;
    border-right-color: ${(props) => props.theme.colours.borderColour};
  }
  ...
  .react-datepicker__navigation--next {
    right: 10px;
    border-left-color: ${(props) => props.theme.colours.borderColour};
  }
  ...
  .react-datepicker__navigation--years-previous {
    top: 4px;
    border-top-color: ${(props) => props.theme.colours.borderColour};
  }
  ...
  .react-datepicker__today-button {
    background: ${(props) => props.theme.button.default.backgroundColour};
    border-top: 1px solid ${(props) => props.theme.colours.borderColour};
    cursor: pointer;
    text-align: center;
    font-weight: bold;
    padding: 5px 0;
