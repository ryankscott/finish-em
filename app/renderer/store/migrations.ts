  ...
  Object.values(it.items).map((i) => {
    client.mutate({
      ...
      variables: {
        ...
        dueAt: i.dueDate ? i.dueDate : null,
        scheduledAt: i.scheduledDate ? i.scheduledDate : null,
        lastUpdatedAt: i.lastUpdatedAt,
        completedAt: i.completedAt ? i.completedAt : null,
        createdAt: i.createdAt ? i.completedAt : null,
        deletedAt: i.deletedAt ? i.deletedAt : null,
        repeat: i.repeat,
        labelKey: i.labelId,
        areaKey: i.areaId,
      },
