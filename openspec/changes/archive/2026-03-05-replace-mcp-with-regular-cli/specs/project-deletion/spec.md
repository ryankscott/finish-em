...
**Reason**: HTTP/OpenAPI surfaces are removed from the supported product surface in favor of CLI interop and local TUI pathways.
**Migration**: Replace HTTP delete calls with the CLI project deletion command or TUI/direct operation surfaces.
