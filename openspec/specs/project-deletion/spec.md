...
Define project deletion via API and TUI: semantics (reassign tasks to inbox, forbid deleting inbox), success/failure outcomes, and exposure on HTTP API and TUI API.
