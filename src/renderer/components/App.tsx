...
import { useOnlineStatus, useSettings } from '../hooks'
import { GET_APP_DATA } from '../queries/'
import { AppState, useBoundStore } from '../state'
import { registerHandlers } from '../utils/ipcMessageHanders'
...
const App = (): ReactElement => {
  const [activeItemIds, focusbarVisible, setFocusbarVisible, sidebarVisible, setSidebarVisible] =
