...
import QueryBuilder, { defaultValueProcessor, Field, formatQuery } from 'react-querybuilder'
...
export const valueProcessor = (field: string, operator: string, value: any): string => {
  const dateField = [
    'DATE(dueAt)',
    'DATE(completedAt)',
    'DATE(scheduledAt)',
...
const ItemFilterBuilder = ({ onSubmit, defaultFilter }: ItemFilterBuilderProps) => {
