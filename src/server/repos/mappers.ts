...
export function mapProjectRow(row: Record<string, unknown>): Project {
  return {
    ...
    jiraDiscoveryStatus: row.jira_discovery_status ? (String(row.jira_discovery_status) as JiraTicketStatus) : null,
    jiraDeliveryUrl: row.jira_delivery_url ? String(row.jira_delivery_url) : null,
    jiraDeliveryStatus: row.jira_delivery_status ? (String(row.jira_delivery_status) as JiraTicketStatus) : null,
    ...
    jiraDocsStatus: row.jira_docs_status ? (String(row.jira_docs_status) as JiraTicketStatus) : null,
    jiraReleaseNoteUrl: row.jira_release_note_url ? String(row.jira_release_note_url) : null,
    jiraReleaseNoteStatus: row.jira_release_note_status ? (String(row.jira_release_note_status) as JiraTicketStatus) : null,
    teamsReleaseNoteUrl: row.teams_release_note_url ? String(row.teams_release_note_url) : null,
