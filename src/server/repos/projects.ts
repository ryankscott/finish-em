...
export function updateProject(
	...
	const jiraDiscoveryStatus =
		"jiraDiscoveryStatus" in patch
			? (patch.jiraDiscoveryStatus ?? null)
			: existing.jiraDiscoveryStatus;
	const jiraDeliveryUrl =
		"jiraDeliveryUrl" in patch
			? (patch.jiraDeliveryUrl ?? null)
			: existing.jiraDeliveryUrl;
	const jiraDeliveryStatus =
		"jiraDeliveryStatus" in patch
			? (patch.jiraDeliveryStatus ?? null)
			: existing.jiraDeliveryStatus;
	const confluenceUrl =
	...
	const jiraDocsStatus =
		"jiraDocsStatus" in patch
			? (patch.jiraDocsStatus ?? null)
			: existing.jiraDocsStatus;
	...
	const jiraReleaseNoteStatus =
		"jiraReleaseNoteStatus" in patch
			? (patch.jiraReleaseNoteStatus ?? null)
			: existing.jiraReleaseNoteStatus;
