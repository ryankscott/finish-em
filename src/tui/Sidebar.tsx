...
type NavItem = {
	...
	key: string;
	label: string;
	countKey?: "today" | "inbox" | "upcoming" | "completed" | "deleted";
	view: "today" | "inbox" | "upcoming" | "completed" | "deleted" | "settings";
};
...
type SidebarProps = {
	items: SidebarItem[];
	viewCounts?: Partial<
		Record<"today" | "inbox" | "upcoming" | "completed" | "deleted", number> & {
