...
export const PROJECT_CREATE_FIELDS: ModalField[] = [
	...
	{ key: "jiraReleaseNoteUrl", label: "Delivery: Release Note URL", type: "text" },
	{ key: "jiraReleaseNoteStatus", label: "Delivery: Release Note Status", type: "enum" },
...
export const MODAL_MODES = ["createTaskModal", "createProjectModal", "editTaskModal", "editProjectModal"] as const;
